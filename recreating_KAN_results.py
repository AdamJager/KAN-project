...
soln_arr=scipy.integrate.odeint(duffing_deriv, X0, t, args=(alpha, beta, delta, gamma, omega))
...
model = efficientkan(layers_hidden=[2,10,10,2], grid_size=5) #k is order of piecewise polynomial
...
print(f"alpha: {alpha}, beta: {beta}, delta: {delta}, gamma: {gamma}, omega: {omega}")